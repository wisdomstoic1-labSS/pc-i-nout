...
FLAGS = {
    ...
    # У США тринадцать полос в размере превью сливаются в рябь, поэтому их семь.
    # Первые три записи — синий крыж, он занимает треть угла.
    "us": [(0x0A, 0x31, 0x61), (0x0A, 0x31, 0x61), (0x0A, 0x31, 0x61),
           (0xB3, 0x19, 0x42), (255, 255, 255), (0xB3, 0x19, 0x42),
           (255, 255, 255), (0xB3, 0x19, 0x42), (255, 255, 255),
           (0xB3, 0x19, 0x42)],
}
